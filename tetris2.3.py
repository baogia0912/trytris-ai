...
def runGame():
    ...
    while True: # game loop
        ...
        if P1Tspin:
            drawText('T-Spin: ' + str(P1Tspin),20,200, BLUE)
        else:
            drawText('T-Spin: ' + str(P1Tspin),20,200, WHITE)

        if P1Lspin:
            drawText('L-Spin: ' + str(P1Lspin),20,220, BLUE)
        else:
            drawText('L-Spin: ' + str(P1Lspin),20,220, WHITE)
        
        if P1Jspin:
            drawText('J-Spin: ' + str(P1Jspin),20,240, BLUE)
        else:
            drawText('J-Spin: ' + str(P1Jspin),20,240, WHITE)
            
        if P1Sspin:
            drawText('S-Spin: ' + str(P1Sspin),20,260, BLUE)
        else:
            drawText('S-Spin: ' + str(P1Sspin),20,260, WHITE)
            
        if P1Zspin:
            drawText('Z-Spin: ' + str(P1Zspin),20,280, BLUE)
        else:
            drawText('Z-Spin: ' + str(P1Zspin),20,280, WHITE)
            
        if P1Ispin:
            drawText('I-Spin: ' + str(P1Ispin),20,300, BLUE)
        else:    
            drawText('I-Spin: ' + str(P1Ispin),20,300, WHITE)

        if P2Tspin:
            drawText('T-Spin: ' + str(P2Tspin),620,200, BLUE)
        else:
            drawText('T-Spin: ' + str(P2Tspin),620,200, WHITE)
            
        if P2Jspin:
            drawText('J-Spin: ' + str(P2Jspin),620,220, BLUE)
        else:    
            drawText('J-Spin: ' + str(P2Jspin),620,220, WHITE)
            
        if P2Lspin:
            drawText('L-Spin: ' + str(P2Lspin),620,240, BLUE)
        else:    
            drawText('L-Spin: ' + str(P2Lspin),620,240, WHITE)
            
        if P2Sspin:
            drawText('S-Spin: ' + str(P2Sspin),620,260, BLUE)
        else:    
            drawText('S-Spin: ' + str(P2Sspin),620,260, WHITE)
            
        if P2Zspin:
            drawText('Z-Spin: ' + str(P2Zspin),620,280, BLUE)
        else:   
            drawText('Z-Spin: ' + str(P2Zspin),620,280, WHITE)
            
        if P2Ispin:
            drawText('I-Spin: ' + str(P2Ispin),620,300, BLUE)
        else:    
            drawText('I-Spin: ' + str(P2Ispin),620,300, WHITE)
