...
def main():
    global FPSCLOCK, DISPLAYSURF, SMALLFONT, BASICFONT, BIGFONT, GAMEMODE
    pygame.init()
...
singlePlayerButton = button(GREEN, 100, 375, 200, 50, 'Single Player')
multiPlayerButton = button(GREEN, 350, 375, 200, 50, 'Multi Player')
exitButton = button(GREEN, 290, 475, 70, 50, 'Exit')

backButton = button(GREEN, 285, 525, 80, 50, 'Back')

sprintButton = button(GREEN, 100, 375, 200, 50, 'Sprint')
survivalButton = button(GREEN, 350, 375, 200, 50, 'Survival')
invisibleButton = button(GREEN, 100, 450, 200, 50, 'Invisible')
monochromeButton = button(GREEN, 350, 450, 200, 50, 'Monochrome')
