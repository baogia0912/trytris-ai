...
def drawText(text, x, y):
    infoSurf = SMALLFONT.render(text, True, GRAY4)
...
def drawInstructions(x, y):
    ...
    drawText('e, c: Hold', x, y + 60)
    drawText('space: Hard drop', x, y + 80)
    drawText('left, a: Move left', x, y + 100)
    drawText('right, d: Move right', x, y + 120)
    drawText('down, s: Soft drop', x, y + 140)
    drawText('up, x: Clockwise', x, y + 160)
    drawText('w, z: Counter clockwise', x, y + 180)
