        ...
        for event in pygame.event.get(): # event handling loop
            ...
            if event.type == KEYDOWN:
                ...
                # hold a peice
                    ...
                    holdPiece['y'] = -2
                    holdPiece['x'] = int(BOARDWIDTH / 2) - int(TEMPLATEWIDTH / 2) -1
...
def getBlankBoard():
    ...
    for i in range(BOARDWIDTH):
        board.append([BLANK] * (BOARDHEIGHT + 20))
    return board
...
def drawBoard(board):
    ...
    pygame.draw.rect(DISPLAYSURF, BORDERCOLOR, (XMARGIN - 2, TOPMARGIN -7, (BOARDWIDTH * BOXSIZE) + 4, (BOARDHEIGHT * BOXSIZE) + 8), 1)
...
def drawNextPiece(NEXT_PIECES):
    ...
    for order, piece in enumerate(NEXT_PIECES):
        drawPiece(piece, pixelx=WINDOWWIDTH-140, pixely=100 + (order * 70))
